    ...
    <div className="bg-apricot-pink min-h-screen px-4 py-16 sm:px-6 sm:py-24 md:grid md:place-items-center lg:px-8">
      <div className="max-w-max mx-auto">
        <main className="sm:flex">
          <p className="number text-4xl font-extrabold text-dark-sienna sm:text-5xl">
            404
          </p>
          <div className="sm:ml-6">
            ...
            <div className="errorLinks mt-10 flex space-x-3 sm:border-l sm:border-transparent sm:pl-6">
              <a
                href="/"
              ...
              <a
                href="/contact-us"
                className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-dark-sienna hover:bg-english-red focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-melon-pink"
              >
                Contact support
              </a>
            </div>
